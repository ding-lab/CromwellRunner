...
SCRATCH_BASE="$WORKFLOW_ROOT/cromwell-workdir/cromwell-executions/tindaisy2.6.cwl"
DEST_BASE="$STORAGE_ROOT/cromwell-workdir/cromwell-executions/tindaisy2.6.cwl"
