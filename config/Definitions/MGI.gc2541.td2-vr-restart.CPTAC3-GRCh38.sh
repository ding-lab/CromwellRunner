...
# New for VAF Rescue
VAF_RESCUE_BED="/gscuser/mwyczalk/projects/TinDaisy/SMG_BED/CCRCC_UMich_SMG/dat/CCRCC_UMich.SMG.v36.bed"
...
CWL="$CWL_ROOT_H/cwl/workflows/td2-vr-rescue_restart.cwl"

# template used for generating YAML files
YAML_TEMPLATE="config/Templates/YAML/td2-vr-rescue_restart.template.yaml"
...
RESTART_ROOT="$WORKFLOW_ROOT/cromwell-workdir/cromwell-executions/tindaisy2.cwl"
